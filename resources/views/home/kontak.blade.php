                    ...
                    <form action="{{ route('contact.post') }}" method="post" role="form" class="php-email-form">
                        ...
                        <div class="row">
                            <div class="col form-group">
                                <input type="text" name="name" class="form-control" id="name" placeholder="Your Name" required minlength="5" maxlength="300">
                            </div>
                            <div class="col form-group">
                                <input type="email" class="form-control" name="email" id="email" placeholder="Your Email" required maxlength="300">
                            </div>
                        </div>
                        <div class="form-group">
                            <input type="text" class="form-control" name="subject" id="subject" placeholder="Subject" required minlength="5" maxlength="300">
                        </div>
                        <div class="form-group">
                            <textarea class="form-control" name="message" rows="5" placeholder="Message" required minlength="5" maxlength="300"></textarea>
                        </div>
                        {{--<div class="my-3">--}}
