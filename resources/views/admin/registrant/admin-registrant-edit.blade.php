                            ...
                            <form class="needs-validation" action="<?= route('kategori.update', ['kategori' => $kategori['id']]) ?>" method="post">
                                ...
                                <div class="row">
                                    <div class="col-md-12 mb-12">
                                        <label for="kategoriNama"><span class="text-danger">*</span> Nama Kategori</label>
                                        <input type="text" id="kategoriNama" class="form-control @error('nama') is-invalid @enderror"
                                               name="nama" minlength="3" maxlength="20" placeholder="Susu Bubuk.." value="{{ old('nama', $kategori['kategori_name']) }}" required>
                                            @error('nama')
