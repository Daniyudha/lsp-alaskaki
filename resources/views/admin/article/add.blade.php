      ...
      <div class="row justify-content-center">
        <div class="col-lg-12">
          <div class="card">
            ...
            <div class="card-body">
              <h4 class="header-title">Tambahkan Artikel ke Website</h4>
              <p class="card-title-desc">Artikel seperti berita terbaru, untuk dibaca oleh pengunjung website.</p>
              <form id="form-add-news" method="post" action="{{ route('news.store') }}" enctype="multipart/form-data">
                @csrf
                <div class="row justify-content-center">
                  ...
                  <div class="col-md-6 mb-4">
                    <label><span class="text-danger">*</span> Gambar</label>
                  ...
                  <div class="col-md-12 mb-4">
                    ...
                    <textarea type="text" name="content_thumbnail" class="form-control @error('content_thumbnail') is-invalid @enderror"
                              ...
                              minlength="20" maxlength="200" required cols="5" rows="3">{{ old('content_thumbnail') ?? null }}</textarea>
                  ...
                  <div class="col-md-12 mb-4">
                    ...
                    <textarea type="text" id="content_full" class="form-control @error('content_full') is-invalid @enderror" autofocus="autofocus"
                              name="content_full" maxlength="200000" placeholder="Konten full. Contoh : Bla bla..">{{ old('content_full') ?? null }}</textarea>
                    @error('content_full')
                    <div class="invalid-feedback">
                      {{ $message }}
                    </div>
                ...
                <div class="container">
                  <div class="row">
                    <div class="col text-center">
                      <button class="btn btn-primary" id="btnSubmit" type="submit">Tambahkan Artikel</button>
                    </div>
                  </div>
                </div>
              </form>
